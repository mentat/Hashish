...
pkgdatadir = $(datadir)/Hashish
pkglibdir = $(libdir)/Hashish
pkgincludedir = $(includedir)/Hashish
...
EXTRA_DIST = win32/Hashish.dsw win32/Hashish.dsp win32/hashish_setup_gen.nsi \
	win32/launch.rc
